...
**성장 비교기간**
기간 종료월을 기준으로 **최근 3·6·12·24개월 합계** 중 하나를 선택하고, 바로 앞의 **직전 동일 길이 기간** 합계와 비교합니다. 예를 들어 종료월이 2026년 8월이고 12개월을 선택하면 2025년 9월~2026년 8월 합계와 2024년 9월~2025년 8월 합계를 비교합니다. `성장률=(최근합계/직전합계-1)×100`, `증가액=최근합계-직전합계`입니다. 필요한 과거 데이터가 없는 기간은 선택지에서 제외됩니다. **상단 시작일은 수출 성장 순위 계산에 사용하지 않고 종료월만 기준으로 사용**합니다.

**기여도와 최소규모**  
`기여도=항목 증가액/전체 항목 증가액 합계×100`입니다. 감소 항목이 섞이면 음수 또는 100% 초과가 가능합니다. 최소 비교규모는 직전 동일기간 합계에 적용됩니다.
"""
