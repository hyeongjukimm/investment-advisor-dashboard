...
**기준 연도 성장률**
**완료된 연도**는 1~12월 수출합계를 전년도 1~12월과 비교합니다. **진행 중인 연도**는 1월부터 최신 공표월까지의 누계를 전년 같은 월까지의 누계와 비교합니다. 예를 들어 2026년 자료가 8월까지 있으면 2026년 1~8월과 2025년 1~8월을 비교합니다. `성장률=(기준 연도 합계/전년 동기간 합계-1)×100`, `증가액=기준 연도 합계-전년 동기간 합계`입니다. 이 페이지는 별도의 **기준 연도**를 사용하므로 상단 시작일·종료일을 표시하지 않습니다.
